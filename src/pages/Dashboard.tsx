        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              <Link to="/" className="w-8 h-8 bg-black rounded-lg flex items-center justify-center hover:bg-gray-800 transition-colors">
          ...
          <div className="flex flex-col bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="border-t border-gray-200 p-4">
              <ChatInput
                ...
                disabled={isLoading || (chatState.step !== 'design' && chatState.step !== 'preview')}
